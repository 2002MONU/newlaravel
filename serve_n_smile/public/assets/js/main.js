(function ($) {
    ...
    if ($.fn.meanmenu) {
         var homeUrl = $('nav#dropdown').data('home-url');
        $('nav#dropdown').meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='" + homeUrl + "'>\n\
<img src='https://demo.colormoon.in/serve_n_smile/public/assets/dynamics/1725279637.png' alt='logo' class='img-fluid'/></a></div>"
        });
    }
