                  ...
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="post_by" placeholder="Enter post by " value="{{old('post_by')}}"> 
                           @error('post_by')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="number" class="form-control "   name="like" placeholder="Enter like " value="{{old('like')}}"> 
                           @error('like')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="number" class="form-control "   name="comments" placeholder="Enter comments " value="{{old('comments')}}"> 
                           @error('comments')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-12 col-lg-12 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control "   name="description" placeholder="Enter heading " value=""> {{old('description')}}</textarea>
                           @error('description')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                      ...
                      <div class="col-xxl-12 col-lg-12 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control ckeditor"   name="blog_description" placeholder="Enter blog_description " value=""> {{old('blog_description')}}</textarea>
