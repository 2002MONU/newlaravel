                  ...
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-12 col-lg-12 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control ckeditor"  rows="4"  name="description" placeholder="Enter heading " value=""> {{old('description',$testimonial->description)}}</textarea>
                           @error('description')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
