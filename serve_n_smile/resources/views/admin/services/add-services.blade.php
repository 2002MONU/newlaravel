                  ...
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="cleaning_hour" placeholder="Enter cleaning_hour " value="{{old('cleaning_hour')}}"> 
                           @error('cleaning_hour')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="no_of_cleaner" placeholder="Enter no_of_cleaner " value="{{old('no_of_cleaner')}}"> 
                           @error('no_of_cleaner')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="visiting_hours" placeholder="Enter visiting_hours " value="{{old('visiting_hours')}}"> 
