          ...
          <div class="card">
            ...
            <form action="{{route('sociallinks.update',['sociallink' => $social->id])}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row gx-3">
                ...
                <div class="col-xxl-6 col-lg-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label" for="a1">Google Plus </label>
                        <input type="url" class="form-control" name="google_plus" placeholder="Enter google_plus" value="{{$social->google_plus}}">
                        @error('google_plus')
                        <div class="error text-danger">{{ $message }}</div>
                        @enderror  
                    </div>
                ...
                <div class="col-xxl-6 col-lg-6 col-sm-12">
                  <div class="mb-3">
                    <label class="form-label" for="a2">Spanchat </label>
                    <input type="url" class="form-control " name="snapchat" placeholder="Enter snapchat" value="{{$social->spanchat}}">
                    @error('snapchat')
                    <div class="error text-danger">{{ $message }}</div>
                    @enderror 
                </div>
              ...
              <div class="col-xxl-6 col-lg-6 col-sm-12">
                <div class="mb-3">
                  ...
                  <div class="col-xxl-6 col-lg-6 col-sm-12">
                <div class="mb-3">
                  <label class="form-label" for="a2">Pinterest </label>
                  <input type="url" class="form-control text-dark"  name="pinterest" placeholder="Enter pinterest" value="{{$social->pinerent}}">
                   @error('pinterest')
                  <div class="error text-danger">{{ $message }}</div>
                  @enderror
              </div>
            ...
            <div class="col-xxl-6 col-lg-6 col-sm-12">
              <div class="mb-3">
                <label class="form-label" for="a2">Open Time </label>
                <input type="text" class="form-control text-dark"  name="open_time" placeholder="Enter open_time" value="{{$social->open_time}}">
                 @error('open_time')
                <div class="error text-danger">{{ $message }}</div>
                @enderror
            </div>
