                  ...
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="h1" placeholder="Enter title " value="{{$whychoose->h1}}">
                           @error('h1')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="h2" placeholder="Enter title " value="{{$whychoose->h2}}">
                           @error('h2')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="h3" placeholder="Enter title " value="{{$whychoose->h3}}">
                           @error('h3')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="h4" placeholder="Enter title " value="{{$whychoose->h4}}">
                           @error('h4')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control ckeditor"   name="description" placeholder="Enter description " >{{$whychoose->description}}</textarea>
                           @error('description')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
