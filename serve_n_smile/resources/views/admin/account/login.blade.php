...
<html lang="en">
   ...
   <head>
      ...
      <title>Serve N Smile| Login</title>
      <!-- Meta -->
      <meta name="description" content="Urban Build  Admin Dashboards ">
      <meta property="og:title" content="Urban Buildm">
         ...
         <div class="auth-wrapper">
            ...
            <form action="{{route('admin.login-post')}}" method="POST">
               ...
               <div class="auth-box">
                  ...
                  <img class=" p-2" src="{{asset('assets/dynamics/'.$site_setting->header_logo)}}" alt="Login Logo" >
                  </a>
