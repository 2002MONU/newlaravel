                  ...
                  <div id="questions-container">
                     <div class="row gx-3 mb-3 question-group">
                        <div class="col-xxl-6 col-lg-6 col-sm-12">
                            <label class="form-label" for="status">Services <span class="text-danger">*</span></label>
                        ...
                        <div class="col-xxl-12 col-lg-12 col-sm-12">
                           ...
                           <textarea type="text" class="form-control" name="question[]" rows="2">{{old('question.0')}}</textarea>
                           @error('question.0')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                        <div class="col-xxl-12 col-lg-12 col-sm-12">
                           ...
                           <textarea type="text" class="form-control" name="answer[]" rows="3">{{old('answer.0')}}</textarea>
                           @error('answer.0')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
...
<script>
   document.getElementById('add-more').addEventListener('click', function () {
       ...
       newQuestion.classList.add('row', 'gx-3', 'mb-3', 'question-group');
