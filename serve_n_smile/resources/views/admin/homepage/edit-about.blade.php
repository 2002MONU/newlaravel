   ...
   <div class="row gx-3">
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <form action="{{route('homeabouts.update',['homeabout'=>$about->id])}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <!-- Row starts -->
                  <div class="row gx-3">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">About Image </label>
                           <input type="file" id="fileInput1" class="form-control file-input" name="image"  placeholder="Enter banner link " >
                           <span> ( Note:IMG TYPE:- JPEG,PNG,JPG,WEBP,SIZE:2MB Dimension:-400X500 PX)</span><br>
                           <a target="_blank" href="{{asset('assets/dynamics/'.$about->image)}}"><img src="{{asset('assets/dynamics/'.$about->image)}}" style="width: 120px;height:80px;"></a>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">About Image 2 </label>
                           <input type="file" id="fileInput1" class="form-control file-input" name="image2"  placeholder="Enter banner link " >
                           <span> ( Note:IMG TYPE:- JPEG,PNG,JPG,WEBP,SIZE:2MB Dimension:-450X550 PX)</span><br>
                           <a target="_blank" href="{{asset('assets/dynamics/'.$about->image2)}}"><img src="{{asset('assets/dynamics/'.$about->image2)}}" style="width: 120px;height:80px;"></a>
                           <span id="messagefileInput1" class="text-danger"></span>
                           @error('image2')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
