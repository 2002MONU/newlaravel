          ...
          <div class="card">
            ...
            <form action="{{route('teams.store')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row gx-3">
                ...
                <div class="col-xxl-6 col-lg-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="designation" placeholder="Enter Title" value="">
                        @error('designation')
                        <div class="error text-danger">{{ $message }}</div>
                        @enderror  
                    </div>
                ...
                <div class="col-xxl-6 col-lg-6 col-sm-12">
                  <div class="mb-3">
                      ...
                      <textarea type="text" class="form-control" name="facebook" placeholder="Enter facebook" value="{{old('facebook')}}"></textarea>
                      @error('designation')
                      <div class="error text-danger">{{ $message }}</div>
                      @enderror  
                  </div>
              ...
              <div class="col-xxl-6 col-lg-6 col-sm-12">
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" name="twitter" placeholder="Enter twitter" value="">{{old('twitter')}}</textarea>
                    @error('twitter')
                    <div class="error text-danger">{{ $message }}</div>
                    @enderror  
                </div>
            ...
            <div class="col-xxl-6 col-lg-6 col-sm-12">
              <div class="mb-3">
                  ...
                  <textarea type="text" class="form-control" name="linkedin" placeholder="Enter linkedin" >{{old('linkedin')}}</textarea>
                  @error('linkedin')
                  <div class="error text-danger">{{ $message }}</div>
                  @enderror  
              </div>
