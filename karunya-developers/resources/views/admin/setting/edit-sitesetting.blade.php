            ...
            <div class="card-body">
               <form action="{{route('sitesettings.update',['sitesetting' => $site_setting->id ])}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                   ...
                   <div class="col-xxl-6 col-lg-6 col-sm-12">
                     <div class="mb-3">
                       ...
                       <a target="_blank" href="{{asset('assets/dynamics/'.$site_setting->footer_logo)}}">
                        <img src="{{asset('assets/dynamics/'.$site_setting->footer_logo)}}" style="width:120px;height:80px;" class="bg-dark"></a>
                       <span id="messagefileInput2" class="text-danger"></span>
                       @error('footer_logo')
                        <div class="error text-danger">{{ $message }}</div>
                        @enderror
                   ...
                   <div class="col-xxl-6 col-lg-6 col-sm-12">
                     <div class="mb-3">
                        <label class="form-label" for="a2">HowItWork_banner  background  <span >( IMG-TYPE: JPG,PNG,JPEG, SIZE:2MB )</span></label>
                        <input type="file" class="form-control file-input"  id="fileInput10" name="howItWork_banner" >
                        <a target="_blank" href="{{asset('assets/dynamics/'.$site_setting->howItWork_banner)}}">
                           <img src="{{asset('assets/dynamics/'.$site_setting->howItWork_banner)}}" style="width:120px;height:80px;"></a>
                       <span id="messagefileInput10" class="text-danger"></span>
                        @error('howItWork_banner')
                        <div class="error text-danger">{{ $message }}</div>
                        @enderror
                     </div>
                  </div>
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Blog_banner <span>( IMG-TYPE: JPG,PNG,JPEG, SIZE:2MB )</span></label>
                           <input type="file" class="form-control file-input"  id="fileInput4" name="blog_banner" >
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="file" class="form-control file-input"  id="fileInput5" name="project_banner" >
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Testimonial_banner<span >( IMG-TYPE: JPG,PNG,JPEG,WEBP, SIZE:2MB )</span></label>
                           <input type="file" class="form-control file-input"  id="fileInput5" name="testimonial_banner" >
                           <a target="_blank" href="{{asset('assets/dynamics/'.$site_setting->testimonial_banner)}}">
                              <img src="{{asset('assets/dynamics/'.$site_setting->testimonial_banner)}}" style="width:120px;height:80px;"></a>
                          <span id="messagefileInput5" class="text-danger"></span>
                           @error('testimonial_banner')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror
                        </div>
                     </div>
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Gallery_banner<span >( IMG-TYPE: JPG,PNG,JPEG,WEBP, SIZE:2MB )</span></label>
                           <input type="file" class="form-control file-input"  id="fileInput5" name="gallery_banner" >
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Joinwith_banner<span >( IMG-TYPE: JPG,PNG,JPEG,WEBP, SIZE:2MB )</span></label>
                           <input type="file" class="form-control file-input"  id="fileInput5" name="joinwith_banner" >
                           <a target="_blank" href="{{asset('assets/dynamics/'.$site_setting->joinwith_banner)}}">
                              <img src="{{asset('assets/dynamics/'.$site_setting->joinwith_banner)}}" style="width:120px;height:80px;"></a>
                          <span id="messagefileInput5" class="text-danger"></span>
                           @error('joinwith_banner')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror
                        </div>
                     </div>
