               ...
               <div class="card-body">
                  <div class="d-flex align-items-center">
                     ...
                     <div class="d-flex flex-column">
                        <h2 class="lh-1">{{$onGoingProject}}</h2>
                        <p class="m-0">On Going Project </p>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="card mb-3">
               <div class="card-body">
                  <div class="d-flex align-items-center">
                     ...
                     <div class="d-flex flex-column">
                        <h2 class="lh-1">{{$upComingProject}}</h2>
                        <p class="m-0">Upcoming Project </p>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="card mb-3">
               <div class="card-body">
                  <div class="d-flex align-items-center">
                     ...
                     <div class="d-flex flex-column">
                        <h2 class="lh-1">{{$CompletedProject}}</h2>
