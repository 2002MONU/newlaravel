   ...
   <div class="row gx-3">
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <form action="{{route('home-why-chooses.update',$whyChooseUs->id)}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <!-- Row starts -->
                  <div class="row gx-3">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control ckeditor"   name="mission_description" placeholder="Enter mission_description " >{{$whyChooseUs->mission_description}}</textarea>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control ckeditor"   name="vission_description" placeholder="Enter vission_description " >{{$whyChooseUs->vission_description}}</textarea>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Value Description <span class="text-danger">*</span> </label>
                           <textarea type="text" class="form-control ckeditor"   name="value_description" placeholder="Enter value_description " >{{$whyChooseUs->value_description}}</textarea>
