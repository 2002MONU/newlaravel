                        ...
                        <div class="page-title-box">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3 ml-5 d-flex justify-content-left">
                                    <a href="{{ route('services.create') }}" class="btn btn-primary"><i class="fa fa-plus mr-1"></i>Add New</a>
                                ...
                                @foreach ($service as $data)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="{{ route('services.edit', $data->id) }}" class="btn btn-sm btn-success mb-2"><i class="fa fa-pencil  mr-1"></i>Edit</a>
                                            <form method="POST" action="{{ route('services.destroy', $data->id) }}" class="delete-form ml-2">
                                                @csrf
                                                @method('DELETE')
