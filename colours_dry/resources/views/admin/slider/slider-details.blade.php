                        ...
                        <div class="page-title-box">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3 ml-5 d-flex justify-content-left">
                                    <a href="{{ route('sliders.create') }}" class="btn btn-primary"><i class="fa fa-plus mr-1"></i>Add Slider</a>
                            ...
                            <tbody>
                                ...
                                @foreach ($sliders as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->title }}</td>
                                        <td>{{ $data->heading }}</td>
                                        <td><a target="_blank" href="{{asset('admin/serviceImage/'.$data->banner_image)}}">
                                            <img src="{{asset('admin/serviceImage/'.$data->banner_image)}}" style="width: 100px;height:70px;"></a></td>
                                        <td>{{ $data->status == 1 ? 'Active' : 'Inactive' }}</td>
                                        <td>{{ $data->priority }}</td>
                                        <td class="d-flex justify-content-center">
                                            <a href="{{ route('sliders.edit', $data->id) }}" class="btn btn-sm btn-success mb-2"><i class="fa fa-pencil  mr-1"></i>Edit</a>
