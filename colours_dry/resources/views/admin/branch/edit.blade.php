                                ...
                                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12" style="margin-left: -19px;">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active"><a href="{{ route('branches.index') }}">@yield('title')</a></li>
                        ...
                        <div class="row p-4">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ $branch->name }}" class="form-control" placeholder="Enter name" id="name">
                                    @error('name')
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="priority" value="{{ $branch->priority }}" class="form-control" placeholder="Enter Priority" id="priority">
                                    @error('priority')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
