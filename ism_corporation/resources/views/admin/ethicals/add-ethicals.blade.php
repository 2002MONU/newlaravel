...
@section('title') Add Ethical Product  @endsection
   ...
   <div class="row gx-3">
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <form action="{{route('ethicals.store')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <!-- Row starts -->
                  <div class="row gx-3">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control ckeditor"  name="icon" placeholder="Enter icon " value="">{{old('icon')}}</textarea>
                           @error('icon')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
