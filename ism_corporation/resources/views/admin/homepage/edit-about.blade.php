            ...
            <div class="card-body">
               <form action="{{route('homeabouts.update',['homeabout'=>$about->id])}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Banner Image </label>
                           ...
                           <a target="_blank" href="{{asset('assets/dynamics/slider/'.$about->image)}}"><img src="{{asset('assets/dynamics/slider/'.$about->image)}}" style="width: 120px;height:80px;"></a>
