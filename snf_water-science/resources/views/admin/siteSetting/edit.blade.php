                        ...
                        <div class="row p-4">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <br />
                                    <a href="{{ asset('admin/siteImage/logo/' . $sitesettings->logo) }}" target="_blank" rel="noopener noreferrer"><img src="{{ asset('admin/siteImage/logo/' . $sitesettings->logo) }}" alt=""
                                        style="width:200px;"></a>
                                    @error('logo')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <span>Image <code>Width: 500px & Height: 500px</code></span>
                                    <br />
                                    <a href="{{ asset('admin/siteImage/favicon/' . $sitesettings->favicon) }}" target="_blank" rel="noopener noreferrer">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <span>Image <code>Width: 500px & Height: 500px</code></span>
                                    <br />
                                    <a href="{{ asset('admin/siteImage/ftlogo/' . $sitesettings->ftlogo) }}" target="_blank" rel="noopener noreferrer">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="customFile1" class="col-form-label">Linkedin</label>
                                    <input type="text" name="linkedin"
                                        value="{{ old('linkedin', $sitesettings->linkedin) }}"class="form-control"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <span>Image <code>Width: 500px & Height: 500px</code></span>
                                    <br />
                                    <a href="{{ asset('admin/siteImage/og-image/' . $sitesettings->og_image) }}" target="_blank" rel="noopener noreferrer">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <span>Image <code>Width: 500px & Height: 500px</code></span>
                                    <br />
                                    <a href="{{ asset('admin/siteImage/twitter-image/' . $sitesettings->twitter_image) }}" target="_blank" rel="noopener noreferrer">
                            ...
                            <div class="col-6">
                             ...
                             <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="location_address" name="location_address" class="form-control"
                                        placeholder="Enter Location Address"
                                        value="{{ old('location_address', $sitesettings->location_address ) }}">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="contact_information" class="col-form-label">Contact Information</label>
                                    <input id="contact_information" name="contact_information" class="form-control"
                                        placeholder="Enter Contact Information"
                                        value="{{ old('contact_information', $sitesettings->contact_information	) }}">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="customFile1" class="col-form-label">Product Video</label>
                                    <input class="form-control" type="file" name="product_video">
                                    <span>Video <code>Size:- 20MB</code></span>
                                    @error('product_video')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="customFile1" class="col-form-label">Product Image</label>
                                    <input class="form-control" type="file" name="product_image">
                                    <br />
                                    <a href="{{ asset('admin/siteImage/og-image/' . $sitesettings->product_image) }}"
                                        target="_blank" rel="noopener noreferrer">
                                        <img src="{{ asset('admin/siteImage/og-image/' . $sitesettings->product_image) }}"
                                            alt="" style="width:150px;height:150px;"></a>
                                    @error('product_image')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
