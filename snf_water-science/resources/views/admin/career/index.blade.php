                        ...
                        <div class="page-title-box">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mt-3 ml-5 d-flex justify-content-left">
                                    <a href="{{ route('careers.create') }}" class="btn btn-primary"><i class="fa fa-plus mr-1"></i>Add New</a>
                                ...
                                @foreach ($careers as $data)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <a href="{{ route('careers.edit', $data->id) }}" class="btn btn-sm btn-success mb-2"><i class="fa fa-pencil  mr-1"></i>Edit</a>
                                            <form method="POST" action="{{ route('careers.destroy', $data->id) }}" class="delete-form ml-2">
                                                @csrf
                                                @method('DELETE')
