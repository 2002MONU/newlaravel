...
@section('maincontent')
    <div class="col-12">
        <div class="card-group box-margin">
                                ...
                                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12" style="margin-left: -19px;">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active"><a href="{{ route('admin.researchtype.index') }}"> Research Typet</a></li>
            ...
            @endif
            <form method="POST" action="{{ route('admin.researchtype.store') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="priority" value="{{ old('priority') }}" class="form-control" placeholder="Enter Priority">
                                @error('priority')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
