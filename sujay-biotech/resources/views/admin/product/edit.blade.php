                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="whatsapp" value="{{ old('whatsapp', $product->whatsapp) }}" class="form-control"
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                @if($product->image)
                                    <img src="{{ asset('admin/productImage/' . $product->image) }}" alt="Product Image" width="100">
                                @endif
