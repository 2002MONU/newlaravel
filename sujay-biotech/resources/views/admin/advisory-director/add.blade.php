    ...
    <div class="col-12">
        <div class="card-group box-margin">
                    ...
                    <div class="page-title-box">
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 mt-3">
                                <h5 style="margin-left: 19px;"> Advisory Directors Add</h5>
                            </div>
            ...
            <!-- end page title -->
                    ...
                    @endif
                    <form method="POST" action="{{ route('add-advisory-directors-post') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="designation"
                                            value="{{ old('designation') }}"class="form-control" placeholder="Enter Designation"
                                            id="designation">
                                        @error('designation')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
