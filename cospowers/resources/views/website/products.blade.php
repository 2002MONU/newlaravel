...
@section('mainwebsite')
<!-- breadcrumb begin -->
<div class="breadcrumb-murtes" style="background: url({{asset('assets/dynamics/'.$site_setting->product_banner)}})">
   <div class="container">
       ...
       <div class="row justify-content-xl-between justify-content-lg-between justify-content-center">
                   ...
                   <div class="sidebar-widget">
                       <div class="all-solutions">
                           ...
                           <ul>
                            ...
                            <li>
                                <a class="active" href="{{route('home.product-details',$product->slug)}}">{{$product->title}}<span class="icon"><i class="fas fa-plus"></i></span></a>
                            </li>
                            @endforeach
           ...
           <div class="col-xl-8 col-lg-8 col-md-10">
               <div class="service-details-area">
                   <div class="part-img">
                       <img src="{{asset('assets/dynamics/'.$product->image)}}" alt="product">
                   </div>
