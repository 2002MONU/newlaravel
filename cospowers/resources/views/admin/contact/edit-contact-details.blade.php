            ...
            <div class="card-body">
               <form action="{{route('contactdetails.update',['contactdetail'=>$contact->id])}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Call  No <span class="text-danger">*</span> </label>
                           <input type="number" class="form-control "   name="call_no" placeholder="Enter alter_phone_no " value="{{$contact->call_no}}"> 
                           @error('call_no')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="number" class="form-control "   name="whattsapp" placeholder="Enter whatapps " value="{{$contact->whattsapp}}"> 
                           @error('whattsapp')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
