          ...
          <div class="card">
            ...
            <form action="{{route('sociallinks.update',['sociallink' => $social->id])}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row gx-3">
                ...
                <div class="col-xxl-6 col-lg-6 col-sm-12">
                    <div class="mb-3">
                        <label class="form-label" for="a1">Youtube </label>
                        <input type="url" class="form-control" name="youtube" placeholder="Enter youtube" value="{{$social->youtube}}">
                        @error('youtube')
                        <div class="error text-danger">{{ $message }}</div>
                        @enderror  
                    </div>
                ...
                <div class="col-xxl-6 col-lg-6 col-sm-12">
                  <div class="mb-3">
                    ...
                    <input type="url" class="form-control " name="instagram" placeholder="Enter snapchat" value="{{$social->instagarm}}">
                    @error('instagram')
                    <div class="error text-danger">{{ $message }}</div>
                    @enderror 
                </div>
