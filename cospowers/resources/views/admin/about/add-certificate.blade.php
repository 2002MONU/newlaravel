...
@section('title') Add Certificates  @endsection
               ...
               <form action="{{route('certificates.store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Certificate Image <span class="text-danger">*</span></label>
                           <input type="file" id="fileInput1" class="form-control file-input" name="image"  >
                           <span> ( Note:IMG TYPE:-JPEG,PNG,JPG,WEBP,SIZE:2MB Dimension:- 250X250 PX)</span>
