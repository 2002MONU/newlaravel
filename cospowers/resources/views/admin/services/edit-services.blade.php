            ...
            <div class="card-body">
               <form action="{{route('services.update',['service'=>$service->id])}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Service image <span class="text-danger">*</span></label>
                           ...
                           <a target="_blank" href="{{asset('assets/dynamics/'.$service->image)}}" target="_blank">
                            <img src="{{asset('assets/dynamics/'.$service->image)}}" style="width:80px;height:80px;"></a>
