...
@section('title') Add Careers  @endsection
                  ...
                  <div class="row gx-3">
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="job_name" placeholder="Enter job_name " value="{{old('job_name')}}"> 
                           @error('job_name')
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="job_type" placeholder="Enter job_type " value="{{old('job_type')}}"> 
                           @error('job_type')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Job Title <span class="text-danger">*</span> </label>
                           <input type="text" class="form-control "   name="job_title" placeholder="Enter job_title " value="{{old('job_title')}}"> 
                           @error('job_title')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="text" class="form-control "   name="job_time" placeholder="Enter job_time " value="{{old('job_time')}}"> 
                           @error('job_time')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="number" class="form-control"  name="priority" placeholder="Enter priority " value="{{old('')}}">
                           @error('priority')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-12 col-lg-12 col-sm-12">
                        <div class="mb-3">
                           ...
                           <textarea type="text" class="form-control "   name="description" placeholder="Enter heading " value=""> {{old('')}}</textarea>
                           @error('description')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
