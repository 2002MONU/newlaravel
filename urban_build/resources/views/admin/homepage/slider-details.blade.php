                  ...
                  <tbody>
                     @foreach ($sliders as $slider)
                       <tr>
                            ...
                            <td >{{ $slider->span_01 }}</td>
                            <td >{{ $slider->span_02 }}</td>
                            <td >{{ $slider->h_01 }}</td>
                            <td >{{ $slider->h_02 }}</td>
                            <td >{{ $slider->h_03 }}</td>
                            <td ><a target="_blank" href="{{asset('assets/dynamics/'.$slider->banner_image)}}">
                              <img src="{{asset('assets/dynamics/'.$slider->banner_image)}}" style="width: 120px;height:80px;"></a></td>
