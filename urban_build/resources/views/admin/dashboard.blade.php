            ...
            <div class="card mb-3">
               <div class="card-body">
                  <div class="d-flex align-items-center">
                     ...
                     <div class="d-flex flex-column">
                        <h2 class="lh-1">{{$ongoing}}</h2>
                        <p class="m-0">Ongoing Project </p>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="card mb-3">
               <div class="card-body">
                  <div class="d-flex align-items-center">
                     ...
                     <div class="d-flex flex-column">
                        <h2 class="lh-1">{{$contactMessage}}</h2>
            ...
            <div class="card mb-3">
               <div class="card-body">
                  <div class="d-flex align-items-center">
                     ...
                     <div class="d-flex flex-column">
                        <h2 class="lh-1">{{$enquiryMessage}}</h2>
            ...
            <div class="card mb-3">
               <div class="card-body">
                  <div class="d-flex align-items-center">
                     ...
                     <div class="d-flex flex-column">
                        <h2 class="lh-1">{{$contactEnquiry}}</h2>
