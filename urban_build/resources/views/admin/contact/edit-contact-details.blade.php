                  ...
                  <div class="row gx-3">
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="number" class="form-control "   name="mobile_no" placeholder="Enter mobile no " value="{{$contact->mobile_no}}"> 
                           @error('mobile_no')
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Header Mobile No <span class="text-danger">*</span> </label>
                           <input type="number" class="form-control "   name="header_mobile_no" placeholder="Enter mobile no " value="{{$contact->header_mobile_no}}"> 
                           @error('header_mobile_no')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Alternative Email <span class="text-danger">*</span> </label>
                           <input type="email" class="form-control "   name="alter_email" placeholder="Enter alter_email " value="{{$contact->alter_email}}"> 
                           @error('alter_email')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <input type="url" class="form-control"  name="youtube" placeholder="Enter youtube" value="{{$contact->youtube}}">
                           @error('youtube')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
                        </div>
