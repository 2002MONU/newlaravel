               ...
               <form action="{{route('packages.update',$packages->id)}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row gx-3">
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           <label class="form-label" for="a2">Package Name <span class="text-danger">*</span> </label>
                           <input type="text" class="form-control "   name="package_name" placeholder="Enter package_name " value="{{$packages->package_name}}"> 
                           @error('package_name')
                    ...
                    <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <select name="status" id="" class="form-control">
                              ...
                              <option value="0" {{$packages->status == 0 ? 'selected' : ''}}>Inactive</option>
                           </select>
                           @error('status')
                           <div class="error text-danger">{{ $message }}</div>
                           @enderror 
