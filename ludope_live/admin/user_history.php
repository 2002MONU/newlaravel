...
$two_player = mysqli_query($conn, "select * from gamebet where userid='" . $user['id'] . "' AND tabletype= '12' AND losewin= 'winner' ORDER BY id DESC");
$two_won = mysqli_num_rows($two_player);

$four_player = mysqli_query($conn, "select * from gamebet where userid='" . $user['id'] . "' AND tabletype= '14' AND losewin= 'winner' ORDER BY id DESC");
                                            ...
                                            <table id="" class="table table-striped table-bordered nowrap" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr><td><b>Total Deposited Amount</b></td><td><?php
                                                            $s = mysqli_query($conn, "SELECT COALESCE(SUM(amount),0) as total from payment where uid = '" . $user['id'] . "' AND trnstype = 'deposit' and status = 'success'");
                                                    ...
                                                    <tr><td><b>Total 2player Games Won</b></td><td><?php echo $two_won ?></td></tr>

                                                    <tr><td><b>Total 4player Games Won</b></td><td><?php echo $four_won ?></td></tr>
                                                    ...
                                                    <tr><td><b>Deposit Wallet</b></td> <td><?php echo $user['coins']; ?></td></tr>
                                                    <tr><td><b>Win Wallet</b></td> <td><?php echo $user['winning_amount']; ?></td></tr>
