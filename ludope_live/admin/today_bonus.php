                ...
                <div class="box box-info">
                    ...
                    <section class="content">
                        ...
                        <div class="box-body">
                                ...
                                <table id="" class="table table-striped table-bordered nowrap" style="width:100%" border="1">
                                    ...
                                    <tbody>
                                        ...
                                        if ($_GET['export'] == 'today') {
                                            $sqlnew = mysqli_query($conn, "SELECT * FROM bonus WHERE (date BETWEEN '$today_start' AND '$today_end') and (bonus_type='Signup' || bonus_type='Bonus Transfer' || bonus_type='Referred' || bonus_type='Referral') LIMIT $start_from, $limit");
                                        } else {
                            ...
                            <ul class="pagination">
                                <?php
                                $sqla = "SELECT COUNT(*) FROM bonus WHERE (date BETWEEN '$today_start' AND '$today_end') and (bonus_type='Signup' || bonus_type='Bonus Transfer' || bonus_type='Referred' || bonus_type='Referral')";
