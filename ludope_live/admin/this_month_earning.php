...
<div class="content-wrapper" style="min-height: 837px;">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            This Month Earning <a href="export.php?type=earning&export=this_month" ><div class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export</div></a>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">This Month Earning</li>
                    ...
                    <section class="content">
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <ul class="pagination">
                                    <?php
                                    $sqla = "SELECT COUNT(*) FROM gamebet WHERE status = 'completed' AND (gtime BETWEEN '$month_start' AND '$month_end') and wng_amount>0";
                                    ...
                                    if ($currentPage > 1) {
                                        echo '<li><a href="?page=' . ($currentPage - 1) . '&type=earning&export=this_month">Previous</a></li>';
                                    }
                                    ...
                                    for ($i = $start; $i <= $end; $i++) {
                                        if ($i == $currentPage) {
                                            ...
                                            echo '<li><a href="?page=' . $i . '&type=earning&export=this_month">' . $i . '</a></li>';
                                        }
                                    }

                                    // Display "Next" link if not on the last page
                                    if ($currentPage < $totalPages) {
                                        echo '<li><a href="?page=' . ($currentPage + 1) . '&type=earning&export=this_month">Next</a></li>';
                                    }
                                    ?>
                                </ul>
