...
<div class="content-wrapper" style="min-height: 837px;">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            This Month Bonus Given <a href="bonus_export.php?export=this_month" ><div class="btn btn-success"><i class="fa fa-file-excel-o"></i> Export</div></a>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">This Month Bonus Given</li>
                ...
                <div class="box box-info">
                    ...
                    <section class="content">
                        ...
                        <div class="box-body">
                                ...
                                <table id="" class="table table-striped table-bordered nowrap" style="width:100%" border="1">
                                    ...
                                    <tbody>
                                        ...
                                        if ($_GET['export'] == 'today') {
                                            ...
                                            $sqlnew = mysqli_query($conn, "SELECT * FROM bonus WHERE (date BETWEEN '$month_start' AND '$month_end') and (bonus_type='Signup' || bonus_type='Bonus Transfer' || bonus_type='Referred' || bonus_type='Referral') LIMIT $start_from, $limit");
                            ...
                            <ul class="pagination">
                                <?php
                                $sqla = "SELECT COUNT(*) FROM bonus WHERE (date BETWEEN '$month_start' AND '$month_end') and (bonus_type='Signup' || bonus_type='Bonus Transfer' || bonus_type='Referred' || bonus_type='Referral')";
                                ...
                                if ($currentPage > 1) {
                                    echo '<li><a href="?page=' . ($currentPage - 1) . '&export=' . $_GET['export'] . '">Previous</a></li>';
                                }
                                ...
                                for ($i = $start; $i <= $end; $i++) {
                                    if ($i == $currentPage) {
                                        ...
                                        echo '<li><a href="?page=' . $i . '&export=' . $_GET['export'] . '">' . $i . '</a></li>';
                                    }
                                }

                                // Display "Next" link if not on the last page
                                if ($currentPage < $totalPages) {
                                    echo '<li><a href="?page=' . ($currentPage + 1) . '&export=' . $_GET['export'] . '">Next</a></li>';
                                }
                                ?>
                            </ul>
                        </div>
