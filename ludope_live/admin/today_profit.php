                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                ...
                                <ul class="pagination">
                                    ...
                                    if ($currentPage > 1) {
                                        echo '<li><a href="?page=' . ($currentPage - 1) . '&type=profit&export=today">Previous</a></li>';
                                    }
                                    ...
                                    for ($i = $start; $i <= $end; $i++) {
                                        if ($i == $currentPage) {
                                            ...
                                            echo '<li><a href="?page=' . $i . '&type=profit&export=today">' . $i . '</a></li>';
                                        }
                                    }

                                    // Display "Next" link if not on the last page
                                    if ($currentPage < $totalPages) {
                                        echo '<li><a href="?page=' . ($currentPage + 1) . '&type=profit&export=today">Next</a></li>';
                                    }
                                    ?>
                                </ul>
