    ...
    <!--                                                <th>AADHAAR Image</th>
                                        ...
                                        <tbody>
                                            ...
                                            if ($_GET['mobile'] != '') {
                                                ...
                                                if ($uinfo['id'] > 0) {
                                                    $kycinfo = mysqli_query($conn, "select * from kyc where user_id='" . $uinfo['id'] . "' order by kid DESC LIMIT $start_from, $limit");
                                                }
                                            } else {
                                                if ($_GET['status'] == '') {
                                                    $status = 'pending';
                                                ...
                                                $kycinfo = mysqli_query($conn, "select * from kyc where status='$status' order by kid DESC LIMIT $start_from, $limit");
                                            }
                                            ?>
                                            <?php
                                            $i = 0;
        ...
        <!--                                                    <td><?php if (!empty($kycin['aadhar_image'])) { ?>
                                                ...
                                                <div class = "modal-dialog">
                                                    ...
                                                    <div class = "modal-content">
                                                        <div class = "modal-header">
                                                            ...
                                                            <h4 class = "modal-title">Name : <?php echo $kycin['name'];
                                                    ?></h4>
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="kycForm<?php echo $kycin['kid']; ?>" method="get" action="kyc.php">
                                                                ...
                                                                <select id="approveStatus<?php echo $kycin['kid']; ?>" name="approve_status" class="form-control">
                        ...
                        <ul class="pagination">
                            <?php
                            $sqla = "SELECT COUNT(*) FROM kyc where status='" . $_GET['status'] . "'";
                            ...
                            if ($currentPage > 1) {
                                echo '<li><a href="?page=' . ($currentPage - 1) . '&status=' . $_GET['status'] . '">Previous</a></li>';
                            }
                            ...
                            for ($i = $start; $i <= $end; $i++) {
                                if ($i == $currentPage) {
                                    ...
                                    echo '<li><a href="?page=' . $i . '&status=' . $_GET['status'] . '">' . $i . '</a></li>';
                                }
                            }

                            // Display "Next" link if not on the last page
                            if ($currentPage < $totalPages) {
                                echo '<li><a href="?page=' . ($currentPage + 1) . '&status=' . $_GET['status'] . '">Next</a></li>';
                            }
                            ?>
                        </ul>
