...
if (isset($_GET["approve_status"])) {
    ...
    if ($status != '') {
        ...
        $sqlr = "UPDATE `kyc` SET bank_status = '$status',reason_bank = '$reason',bank_approve='$status' where kid='$userid'";

        mysqli_query($conn, $sqlr);
    }

    echo '<script>window.location.href="bank_details.php"</script>';
}
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-header with-border">
                        <?php
                        $pending = mysqli_num_rows(mysqli_query($conn, "select * from kyc where bank_approve='pending' and is_bank='yes'"));
                        $approved = mysqli_num_rows(mysqli_query($conn, "select * from kyc where bank_approve='Approved' and is_bank='yes'"));
                        $rejected = mysqli_num_rows(mysqli_query($conn, "select * from kyc where bank_approve='Rejected' and is_bank='yes'"));
                        ?>
                        <h3 class="box-title"><a href="bank_details.php?bank_approve=pending">Pending : <?php echo $pending; ?></a></h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <h3 class="box-title"><a href="bank_details.php?bank_approve=Approved">Approved : <?php echo $approved; ?></a></h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <h3 class="box-title"><a href="bank_details.php?bank_approve=Rejected">Rejected : <?php echo $rejected; ?></a></h3>
...
//                                    }
                                    ...
                                    <a href="bank_details.php"><button type="submit" class="btn btn-primary">Reset</button></a>
    ...
    <!--                                                <th>UPI Name.</th>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($_GET)) {
                                                if ($_GET['mobile'] != '') {
                                                    ...
                                                    if ($uinfo['id'] > 0) {
                                                        $kycinfo = mysqli_query($conn, "select * from kyc where user_id='" . $uinfo['id'] . "' and is_bank='yes' order by kid DESC LIMIT $start_from, $limit");
                                                    }
                                                }
                                                if ($_GET['date1'] != '' && $_GET['date2'] != '') {
                                                    ...
                                                    $kycinfo = mysqli_query($conn, "select * from kyc where bank_approve='$status' and is_bank='yes' order by kid DESC LIMIT $start_from, $limit");
                                                }
                                            } else {
                                                $status = 'pending';
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title">Bank Name : <?php echo $kycin['bankname']; ?></h4>
                                                            <h4 class="modal-title">Account : <?php echo $kycin['account']; ?></h4>
                                                            <h4 class="modal-title">IFSC : <?php echo $kycin['ifsc']; ?></h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form id="kycForm<?php echo $kycin['kid']; ?>" method="get" action="bank_details.php">
        ...
        <!--                                                                <input type="hidden" value="<?php echo $kycin['is_bank']; ?>" name="type" />-->
                        ...
                        <ul class="pagination">
                            <?php
                            $sqla = "SELECT COUNT(*) FROM kyc where bank_approve='" . $_GET['bank_approve'] . "' and is_bank='yes'";
