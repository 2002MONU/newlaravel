            ...
            <div class="row">
                ...
                <!--                <div class="col-md-3">
                                    <div class="inner-div eight-color">
                                        ...
                                        <div class="content-div">
                                            <a href="this_month_manual_deposit.php?export=this_month"><p>This month manual deposit amount</p></a>
                                            <h3 ><?= $this_month_manual_deposited_amount['amount'] ?></h3>
                                        </div>
                                    </div>inner-div
                                </div>-->
                            ...
                            <a href="this_month_profit.php?type=profit&export=this_month"><p>This month profit</p>
                                <h3 >Rs.<?php
                                    if ($this_monthprofit['amount']) {
                                        echo round($this_monthprofit['amount']);
                                    } else {
                                        echo "0";
                                    }
                                    ?>/-</h3></a>
