<?php
require('config.php');//print_r($_POST);die;
...
$date=date("Y-m-d H:i:s");
     mysqli_query($conn, "INSERT INTO `bonus` (`user_id`, `date`, `bonus_type`,`bonus`) VALUES ('$userid', '$date','Payment Deposit','$orderamount')");
        ...
        $insertq = mysqli_query($conn, "update payment set status='Success',BANKTXNID='$referenceId' WHERE uid='" . $userid . "' and orderid='" . $order_id . "' ");
