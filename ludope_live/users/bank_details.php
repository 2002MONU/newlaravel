...
if (isset($_GET["approve_status"])) {
    ...
    if ($status != '') {
        ...
        $sqlr = "UPDATE `kyc` SET bank_status = '$status',reason_bank = '$reason',is_upi='no',bank_approve='$status' where kid='$userid'";
    ...
    <!--                                                <th>UPI Name.</th>
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($_GET)) {
                                                if ($_GET['mobile'] != '') {
                                                    ...
                                                    if ($uinfo['id'] > 0) {
                                                        $kycinfo = mysqli_query($conn, "select * from kyc where user_id='" . $uinfo['id'] . "' and is_bank='yes' order by kid DESC");
                                                    }
                                                }
                                                if ($_GET['date1'] != '' && $_GET['date2'] != '') {
                                                    ...
                                                    $kycinfo = mysqli_query($conn, "select * from kyc where bank_approve='$status' and is_bank='yes' order by kid DESC");
                                                }
                                            } else {
                                                $status = 'pending';
        ...
        <!--                                                                <input type="hidden" value="<?php echo $kycin['is_bank']; ?>" name="type" />-->
                                                                ...
                                                                <select id="approveStatus<?php echo $kycin['kid']; ?>" name="approve_status" class="form-control" onchange="toggleReason(<?php echo $kycin['kid']; ?>)">
                                                                    <?php if ($kycin['bank_approve'] == 'pending') { ?>
                                                                        <option value="Approved">Approve</option>
                                                                        <option value="Rejected">Reject</option>
                                                                    <?php } ?>
                                                                    <?php if ($kycin['bank_approve'] == 'Approved') { ?>
                                                                        <option value="Rejected">Reject</option>
                                                                    <?php } ?>
                                                                </select> <br>
                                                                <?php if ($kycin['bank_approve'] == 'pending') { ?>
                                                                ...
                                                                <?php } ?>                                                                <input type="submit" class="btn btn-success" />
                                                            </form>
                                                        </div>
