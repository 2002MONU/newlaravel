...
$user_privileges = explode(',', $_SESSION['roles']);
$dashboard_privileges = explode(',', $_SESSION['dashboard_roles']);
if ($uid == '') {
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="dashboard.php" class="logo">
                    ...
                    <span class="logo-mini"><?= $app_name ?> Sub Admin</span>

                    <!-- logo for regular state and mobile devices -->

                    <span class="logo-lg"><img src="" height="46" width="46" class="img-circle"><b><?= $app_name ?> Sub Admin</b></span>
