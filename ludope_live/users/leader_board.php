...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
           <?php if($board_type==2){echo "Classic";}else{echo "Lite";}?> Leader Board
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <a href="add-leaders.php?board_type=<?=$board_type?>" class="btn btn-primary">Add <?php if($board_type==2){echo "Classic";}else{echo "Lite";}?> Leader</a>
</div>
...
//                                echo "SELECT * FROM users WHERE id!=1 $where ORDER BY id DESC LIMIT $start_from, $limit";
                                $sqlnew = mysqli_query($conn, "SELECT * FROM leader_board where board_type='$board_type' ORDER BY id DESC");
                                ...
                                while ($user = mysqli_fetch_assoc($sqlnew)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $user['coins']; ?></td>
                                         <td><?php if ($user['type'] == '1') {echo "This Month";}else{echo "Last Month";} ?>
                                          </td>
