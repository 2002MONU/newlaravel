...
<div class="content-wrapper" style="min-height: 837px;">
    ...
    <section class="content-header">
        ...
        <h1>
            ...
            <?php if($_REQUEST['action']=='edit'){echo "Edit";}else{echo "Add New";}?> <?php if($_REQUEST['board_type']==2){echo "Classic";}else{echo "Lite";}?> Price
        </h1>
...
if( $data[0]!='' && $data[1]!='') {
        ...
        if($data[2]=='daily'){$type=1;}else{$type=0;}
