                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" class="form-control" id="current_version" placeholder="Current Version" min="1" name="current_version" value="<?= $constants['current_version'] ?>" required="required">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="commission_percentage" class="col-sm-3 control-label">Global Commission Percentage</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="commission_percentage" class="col-sm-3 control-label">Lite Mode Commission Percentage</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" class="form-control" id="signup_amount" placeholder="Signup Bonus" min="0" max="100" name="signup_amount" value="<?= $constants['signup_amount'] ?>" required="required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select  class="form-control" id="notice_board_display"  name="notice_board_display"> 
                                            <option <?php if($constants['notice_board_display']=='Yes'){echo "selected";}?>>Yes</option>
                                            <option <?php if($constants['notice_board_display']=='No'){echo "selected";}?>>No</option>
                                           </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select  class="form-control" id="whats_new_display"  name="whats_new_display"> 
                                            <option <?php if($constants['whats_new_display']=='Yes'){echo "selected";}?>>Yes</option>
                                            <option <?php if($constants['whats_new_display']=='No'){echo "selected";}?>>No</option>
                                           </select>
