...
@section('title') Enquiry Message @endsection
                     ...
                     <tr>
                            ...
                            <td>
                                <div class="d-inline-flex gap-1">
                                    <a href="{{ route('admin.enquiry-delete', $enquiry->id) }}" class="btn btn-outline-danger btn-sm" onclick="return confirmDeletion(event)">
