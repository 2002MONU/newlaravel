   ...
   <div class="row gx-3">
      <div class="col-sm-12">
         <div class="card">
            ...
            <div class="card-body">
               <form action="{{route('homepages.update',['homepage'=>$slider->id])}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  <!-- Row starts -->
                  <div class="row gx-3">
                     ...
                     <div class="col-xxl-6 col-lg-6 col-sm-12">
                        <div class="mb-3">
                           ...
                           <a target="_blank" href="{{asset('assets/dynamics/slider/'.$slider->banner_image)}}"><img src="{{asset('assets/dynamics/slider/'.$slider->banner_image)}}" style="width: 120px;height:80px;"></a>
